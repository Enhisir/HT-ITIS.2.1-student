...
public class MemoryTest : IClassFixture<WebApplicationFactory<Hw13.CalculatorApp.Program>>
    // TODO: replace MemoryTest with the right generic argument
{
    private readonly HttpClient _client;
    private readonly ITestOutputHelper _output;

    public MemoryTest(WebApplicationFactory<Hw13.CalculatorApp.Program> factory, ITestOutputHelper output)
    {
        _output = output;
